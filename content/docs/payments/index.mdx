...
ClothCraft uses [Creem](https://creem.io) for monthly and yearly subscription payments. One-time credit packs are retained only for legacy compatibility and are hidden from the product UI.
